...
function DroneController(name) {
	...
	this.controls = {
		throttle: new Potentiometer( 13, { origin: 0, returnToOrigin: false }),
		rudder: new Potentiometer( 15, {origin: 0.5, returnToOrigin: true }),
		aileron: new Potentiometer( 11, {origin: 0.5, returnToOrigin: true }),
		elevator: new Potentiometer( 7, {origin: 0.5, returnToOrigin: true }),
	}
}
